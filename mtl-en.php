...
$html		 = file_get_html( 'http://www.autotrainingcentre.com/blog/category/locations/montreal/page/2/' );
$max_post	 = 3;
                    ...
                    <tbody>
                        <tr>
                            <td style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #fff; font-family: 'Open Sans', Arial, sans-serif; font-size: 13px; margin: 0 auto; mso-table-lspace: 0pt; mso-table-rspace: 0pt; padding: 20px 0; text-align: center;" width="100%">
                                <strong><a href="http://www.autotrainingcentre.com/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>" style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; border: 0; color: #fff; outline: none; text-decoration: none;" target="_blank">L&#39;&Eacute;cole de L&#39;Automobile</a> </strong><br />
                                7555 boulevard Henri-Bourassa Est<br />
                                Montreal, Quebec H1E 1N9 Canada<br />
                                ...
                                Email: <a href="montreal@autotrainingcentre.com" style="color: #fff;text-decoration: none;">montreal@autotrainingcentre.com</a> | website: <a href="http://www.autotrainingcentre.com/automotive-mechanic-school-montreal/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>" style="color: #fff;text-decoration: none;" target="_blank">www.autotrainingcentre.com</a><br />
                                <a href="https://www.facebook.com/pages/LEcole-de-lAutomobile/304631222930222?ref=hl" style="color: #fff;text-decoration: none;" target="_blank">Facebook</a> |
                                <a href="https://plus.google.com/u/0/b/112011509790422290954/112011509790422290954/posts" style="color: #fff;text-decoration: none;" target="_blank">Google+</a> |
                                <a href="http://www.autotrainingcentre.com/blog/" style="color: #fff;text-decoration: none;" target="_blank">Blog</a> |
                                <a href="http://twitter.com/ecoleautomtl" style="color: #fff;text-decoration: none;" target="_blank">Twitter</a> |
                                <a href="https://www.linkedin.com/company-beta/3074452/?pathWildcard=3074452" style="color: #fff;text-decoration: none;" target="_blank">LinkedIn</a></td>
