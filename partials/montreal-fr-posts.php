	...
	<tbody>
		...
		<tr>
			...
			<td class="article-excerpt" valign="top">
				<p>
					<?php echo $contents[0] ?>
					<a href="<?php echo $hrefs[0] ?>/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>" target="_blank">En savoir plus</a></p>
			</td>
		</tr>
	</tbody>
</table>
	...
	<tbody>
		...
		<tr>
			...
			<td class="article-excerpt" valign="top">
				<p>
					<?php echo $contents[1] ?>
					<a href="<?php echo $hrefs[1] ?>/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>" target="_blank">En savoir plus</a></p>
			</td>
		</tr>
	</tbody>
</table>
	...
	<tbody>
		...
		<tr>
			...
			<td class="article-excerpt" valign="top">
				<p>
					<?php echo $contents[2] ?>
					<a href="<?php echo $hrefs[2] ?>/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>" target="_blank">En savoir plus</a></p>
			</td>
		</tr>
	</tbody>
</table>
	...
	<tbody>
		...
		<tr>
			...
			<td class="article-excerpt" valign="top">
				<p>
					<?php echo $contents[3] ?>
					<a href="<?php echo $hrefs[3] ?>/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>" target="_blank">En savoir plus</a></p>
			</td>
		</tr>
	</tbody>
</table>
