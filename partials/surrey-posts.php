	...
	<tbody>
		<tr>
			<td colspan="2" valign="top">
				<h2>
					<a href="<?php echo $hrefs[0] ?>/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>"  style="color: #333;text-decoration: none !important;" target="_blank"><?php echo $titles[0] ?></a></h2>
			</td>
		</tr>
		<tr>
			<td class="thumb-img" valign="top">
				<a href="<?php echo $hrefs[0] ?>/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>" target="_blank">
					<img src="<?php echo $images[0] ?>" width="100" height="100" style="width: 100px;height: 100px;" /></a></td>
...
<table class="article">
	<tbody>
		<tr>
			<td colspan="2" valign="top">
				<h2>
					<a href="<?php echo $hrefs[1] ?>/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>" style="color: #333;text-decoration: none !important;" target="_blank"><?php echo $titles[1] ?></a></h2>
			</td>
		</tr>
		<tr>
			<td class="thumb-img" valign="top">
				<a href="<?php echo $hrefs[1] ?>/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>" target="_blank">
					<img src="<?php echo $images[1] ?>" width="100" height="100" style="width: 100px;height: 100px;" /></a></td>
			<td class="article-excerpt" valign="top">
				<p>
					<?php echo $contents[1] ?>
...
<table class="article">
	<tbody>
		<tr>
			<td colspan="2" valign="top">
				<h2>
					<a href="<?php echo $hrefs[2] ?>/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>" style="color: #333;text-decoration: none !important;" target="_blank"><?php echo $titles[2] ?></a></h2>
			</td>
		</tr>
		<tr>
			<td class="thumb-img" valign="top">
				<a href="<?php echo $hrefs[2] ?>/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>" target="_blank">
					<img src="<?php echo $images[2] ?>" width="100" height="100" style="width: 100px;height: 100px;" /></a></td>
			<td class="article-excerpt" valign="top">
				<p>
					<?php echo $contents[2] ?>
...
<table class="article">
	<tbody>
		<tr>
			<td colspan="2" valign="top">
				<h2>
					<a href="<?php echo $hrefs[3] ?>/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>" style="color: #333;text-decoration: none !important;" target="_blank"><?php echo $titles[3] ?></a></h2>
			</td>
		</tr>
		<tr>
			<td class="thumb-img" valign="top">
				<a href="<?php echo $hrefs[3] ?>/?utm_source=newsletter&amp;utm_medium=email&amp;utm_campaign=<?php echo $dt ?>" target="_blank">
					<img src="<?php echo $images[3] ?>" width="100" height="100" style="width: 100px;height: 100px;" /></a></td>
			<td class="article-excerpt" valign="top">
				<p>
					<?php echo $contents[3] ?>
